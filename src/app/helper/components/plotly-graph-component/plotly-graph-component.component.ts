...
export class PlotlyGraphComponentComponent extends BaseResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.graphConfig = this.data.graphConfig ?? { displayModeBar: false, staticPlot: true };
